// Migracao manual (25/09/2026): aulas assincronas e docencia por trio.
// So ACRESCENTA colunas com valor padrao -- nada e apagado nem alterado.
// Uso:  node 20260925-assincrona-trio.cjs            (dry-run: so mostra)
//       node 20260925-assincrona-trio.cjs --aplicar  (aplica, numa transacao)
const { Client } = require("pg");
const APLICAR = process.argv.includes("--aplicar");
const COLUNAS = [
  ["turma_disciplinas", "aulas_assincronas", "integer NOT NULL DEFAULT 0"],
  ["turma_disciplinas", "grupo_trio", "text"],
  ["horarios", "assincrona", "boolean NOT NULL DEFAULT false"],
  ["horarios_experimentais", "assincrona", "boolean NOT NULL DEFAULT false"],
];
