...
//
// FIX 31/08/2026: secao [3] nao comparava d.turno = t.turno no JOIN,
// entao um bloqueio de um turno podia "casar" com uma aula de outro
// turno so por coincidencia de dia_semana+horario_slot (a numeracao
// de aula se repete em cada turno). Isso gerava um numero de
// conflitos muito maior que o real (233 falsos positivos vistos numa
// auditoria real). Corrigido adicionando o match de turno.
//
// Uso:
