...
const ARQUIVO = 'C:\\Projetos\\nexgrade-app\\artifacts\\api-server\\src\\lib\\pdf-carga-horaria.ts';
const APLICAR = process.argv.includes('--aplicar');

const PATCH1_ANTIGO = 'function desenharCabecalhoPagina(page: PDFPage, fontBold: PDFFont, font: PDFFont, nomeEscola: string, ano: number) {';
const PATCH1_NOVO = [
