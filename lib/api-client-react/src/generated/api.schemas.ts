...
export interface Disciplina {
  ...
  cor: string;
  /**
     * CÃƒÂ³digo SAE oficial (SEED-PR), quando conhecido.
     * @nullable
     */
...
export interface Turma {
  ...
  disciplinaIds?: number[];
  /** Carga horÃƒÂ¡ria semanal efetiva por disciplina (override da matriz aplicada, com fallback para a carga global). */
