...
export const ListPlanosResponseItem = zod.object({
  "id": zod.number(),
  "nome": zod.string(),
  "precoMensal": zod.number().describe('Pre�o mensal em centavos. 0 = plano gratuito (Piloto).'),
  "precoAnual": zod.number().nullish().describe('Pre�o anual em centavos, com desconto. Nulo enquanto n�o configurado.'),
...
export const GetEscolaAtualResponse = zod.object({
  "cadastrada": zod.boolean().describe('false quando o usuário\/organização ainda não passou pelo onboarding.'),
...
export const CadastrarEscolaBody = zod.object({
  ...
  "turnosOfertados": zod.string().optional().describe('Lista separada por v�rgula, ex: \'matutino,vespertino\'.'),
...
export const CadastrarEscolaResponse = zod.object({
  ...
  "codigoInep": zod.string().nullish().describe('C�digo INEP oficial da escola perante o MEC.'),
  "nre": zod.string().nullish().describe('N�cleo Regional de Educa��o (SEED-PR) ou equivalente estadual.'),
  "turnosOfertados": zod.string().nullish().describe('Lista separada por v�rgula, ex: \'matutino,vespertino\'.'),
  "resolucaoSeedPr": zod.string().nullish().describe('N�mero da resolu��o SEED-PR (ou equivalente estadual) que rege a escola.'),
  ...
  "telefoneContato": zod.string().nullish(),
  "emailCobranca": zod.string().nullish().describe('E-mail espec�fico usado pelo Asaas pra notificar a escola (boleto\/PIX). Cai pra emailContato quando vazio.'),
  "asaasCustomerId": zod.string().nullish(),
  "asaasSubscriptionId": zod.string().nullish(),
  "asaasStatusAssinatura": zod.union([zod.literal('em_dia'),zod.literal('pendente'),zod.literal('atrasada'),zod.literal('cancelada'),zod.literal(null)]).nullish().describe('Alimentado pelo webhook do Asaas a cada evento de cobran�a.'),
