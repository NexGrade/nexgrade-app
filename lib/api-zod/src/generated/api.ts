...
export const ListPlanosResponseItem = zod.object({
  "id": zod.number(),
  "nome": zod.string(),
  "preco": zod.number().describe('Preço mensal em centavos. 0 = plano gratuito (Piloto).'),
  ...
  "ativo": zod.boolean(),
  "stripePriceId": zod.string().nullish().describe('Preenchido apenas quando a cobrança via Stripe for habilitada (fase de expansão SaaS).')
})
