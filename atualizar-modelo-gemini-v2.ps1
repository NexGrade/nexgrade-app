...
$busca = "const GEMINI_MODEL = `"gemini-3-flash-preview`";"
$novo = "const GEMINI_MODEL = `"gemini-3.5-flash`";"
...
Write-Host "Pronto! Modelo atualizado para gemini-3.5-flash." -ForegroundColor Green
