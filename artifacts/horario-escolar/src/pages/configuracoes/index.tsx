...
// [NOVO] "Dados da Escola" e "Contato para Cobrança" migraram pra
// páginas próprias (Dados da Escola, Assinatura) -- competiam
// visualmente com estes ajustes de sistema (geração de horário,
// formato SEED), que não tem nada a ver com identidade da escola ou
// cobrança.
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Ajustes do sistema e relatórios SEED.</p>
        </div>
